...
public interface SubscriptionConfigurator {
    ...
    public interface SubscriptionToConfigurator {
        ...
        /**
         * Disables automated message acknowledgments.
         * Auto acking is enabled by default.
         *
         * @return self.
         */
        SubscriptionToConfigurator withAutoAckDisabled();
         ...
         * @return created subscription
         */
        <TMessageBody> Subscription using(BasicMessageConsumer<TMessageBody> consumer);
